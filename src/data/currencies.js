export const currencies = {
  ...
  EGP: { symbol: '£', name: 'Egyptian Pound', locale: 'ar-EG', decimals: 2 },
  ...
  LBP: { symbol: '£', name: 'Lebanese Pound', locale: 'ar-LB', decimals: 2 },
  PKR: { symbol: '₨', name: 'Pakistani Rupee', locale: 'ur-PK', decimals: 2 },
  LKR: { symbol: '₨', name: 'Sri Lankan Rupee', locale: 'si-LK', decimals: 2 },
  BDT: { symbol: '৳', name: 'Bangladeshi Taka', locale: 'bn-BD', decimals: 2 },
  NPR: { symbol: '₨', name: 'Nepalese Rupee', locale: 'ne-NP', decimals: 2 },
